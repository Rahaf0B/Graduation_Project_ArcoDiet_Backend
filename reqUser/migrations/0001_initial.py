    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies', models.CharField(blank=True, max_length=150, null=True, verbose_name='allergies')),
                ('diseases', models.CharField(blank=True, max_length=150, null=True, verbose_name='diseases')),
                ...
                ('email_verified', models.BooleanField(default=False, help_text='Designates whether this users email verfied', verbose_name='email_verified')),
            ...
            managers=[
                ('objects', reqUser.models.MyUserManager()),
            ],
        ),
    ]
